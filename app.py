...
# CÁLCULO FUNDAMENTAL: INCIDÊNCIA
...
# Introdução Geral (Explicando a fonte)
if ano_selecionado == "Todos os Anos":
    st.markdown("""
...
# Sem desfecho = Ignorado + Em investigação
...
if pagina_selecionada == "📄 RESUMO":
    ...
    <div class="explanation-box">
        ...
        <ul>
            <li><b>Matriz (Heatmap):</b> Cores quentes (azul) indicam que os dados "andam juntos" (ex: Menos Renda = Mais Dengue). Cores frias (vermelho) indicam o oposto.</li>
